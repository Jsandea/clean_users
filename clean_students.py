...
#Cometido: Este script asiste interactivamente para borrar alumnos del sistema cuya fecha de último acceso sea anterior a una dada.
#
# Ejecución:
...
contra_ldap="ldap1429"
#Datos servidor principal
servidor="172.23.96.2"
contra_servidor="root1989"
...
******************************************************
            ...
            \033[0m""")                                       
    print("=" * 54)
    print("Limpiar Usuarios Alumnos Antiguos - By J. de Sande".center(54))
    print("=" * 54)
    print("\n[!] REALIZAR COPIA DE SEGURIDAD DEL SERVIDOR     [!]")
    print("    +--------------------------------------------+")                                           
    print("    |  > Copia seguridad ldap                    |")
    print("    |  > Copia seguridad /home/alumnos          |")
    print("    +--------------------------------------------+")
    print("\n[!] Es un asistente, \033[31mno borra datos\033[0m si no hay una confirmación  ")
    print("[!] Ten abierto Rayuela con el alumnado activo, para decidir\n")
...
def borrar_opcional(client, conn, home, usuario):
    ...
    if respuesta != "s" and respuesta != "n":
        ...
        if (result):
            print (f"[*] Se ha borrado el alumno {usuario} del ldap con éxito")
...
if __name__ == "__main__":
    ...
    try:
        ...
        for entry in conn.entries:
            ...
            if len (home) <= 16: #control para evitar borrar el directorio raiz. /home/alumnos
                print (f"[!] El directorio {home} , es un directorio no válido, seguimos con el siguiente elemento\n")
                continue       

            if ("alumnos" in home): #Sólo procesamos los alumnos.
